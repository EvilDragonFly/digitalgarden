...
![三次握手.png](/img/user/jobs/cpp面试问题汇总/fig/三次握手.png)
* 四次挥手断开连接：
...
![四次挥手.png](/img/user/jobs/cpp面试问题汇总/fig/四次挥手.png)
...
![拥塞控制](/img/user/jobs/cpp面试问题汇总/fig/拥塞控制.png)
...
* 非对称加密：需要公钥和私钥，公钥用来加密，私钥用来解密
  ...
  * 常用算法：RSA，ECC，DSA
### （30） 数字证书的了解（高频）
![数字证书.jpg](/img/user/jobs/cpp面试问题汇总/fig/数字证书.jpg)
...
### （38） 服务器攻击（DDos攻击）
### （39）DNS的工作过程和原理
![](/img/user/jobs/cpp面试问题汇总/fig/DNS查询图解.png)
...
![(fig/网络协议层.png](/img/user/jobs/cpp面试问题汇总/fig/网络协议层.png)
...
### （9） B树和B+树的区别（重点）
![Bptree.png](/img/user/jobs/cpp面试问题汇总/fig/Bptree.png)
...
![select](/img/user/jobs/cpp面试问题汇总/fig/select.png)
...
![epoll](/img/user/jobs/cpp面试问题汇总/fig/epoll.png)
...
![管道通信.png](/img/user/jobs/cpp面试问题汇总/fig/管道通信.png)
...
* 三态模型
  ...
  3. 阻塞：有IO事件或者等待其他资源
  ![](/img/user/jobs/cpp面试问题汇总/fig/三态模型.png)
* 五态模型
  1. 新建态：进程刚刚创建。
  2. 就绪态：
  3. 运行态：
  4. 等待态：出现等待事件
  5. 终止态：进程结束
   ![](/img/user/jobs/cpp面试问题汇总/fig/五态模型.png)
...
* 七态模型
  ...
  6. 挂起等待态
  7. 终止态
![](/img/user/jobs/cpp面试问题汇总/fig/七态模型.png)
...
```
### （4） 二维码登录的实现过程 场景题
![](/img/user/jobs/cpp面试问题汇总/fig/二维码登录流程.png)
### （5） 不使用临时变量实现swap函数
...
![](/img/user/jobs/cpp面试问题汇总/fig/bitmap1.png)
...
![](/img/user/jobs/cpp面试问题汇总/fig/布隆过滤器.png)
...
![](/img/user/jobs/cpp面试问题汇总/fig/spark内存一.png)
